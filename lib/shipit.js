...
var rollbackTask = require('./tasks/rollback');
...
/**
 * Initialize rollback tasks.
 *
 * @return {shipit} for chaining
 */

Shipit.prototype.initRollbackTasks = function () {
  rollbackTask(this);
  return this;
};
 ...
 * Clear task queue.
 *
 * @see http://gruntjs.com/api/grunt.task#grunt.task.clearqueue
 * @return {shipit} for chaining
 */

Shipit.prototype.clearQueue = function () {
